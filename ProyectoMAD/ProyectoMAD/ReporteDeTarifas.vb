...
Public Class ReporteDeTarifas
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        Me.Close()

    End Sub

    Private Sub ReporteDeTarifas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim obj2 As New EnlaceBD
        Dim tablaServicio As New DataTable

        If obj2.REPORTE_Tarifas("D", Today()) Then
    ...
    Private Sub ExportDataToPDFTable()
        ...
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Tarifa Basico", font12Bold)))
        'Alignment of phrase in the pdfcell
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        'Add pdfcell in pdftable
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Tarifa Intermedio", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Tarifa Excedente", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If obj2.REPORTE_Tarifas("D", fechaBuscar) Then
            tablaServicio = obj2.tabla
            DataGridView1.DataSource = tablaServicio
