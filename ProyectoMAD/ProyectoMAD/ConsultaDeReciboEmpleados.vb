...
Public Class ConsultaDeReciboEmpleados
    ...
    Private Sub ExportDataToPDFTable()
        ...
        Dim widths As Single() = New Single() {3.0F, 2.5F, 2.0F, 1.5F, 1.5F, 1.0F, 2.0F}
        ...
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Periodo De Factura", font12Bold)))
        'Alignment of phrase in the pdfcell
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        'Add pdfcell in pdftable
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Consumo de kW", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Importe", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Pago", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Pendiente Pago", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Medidor", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Servicio", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
    ...
    Private Sub ConsultaDeReciboEmpleados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If RadioButton5.Checked = True Then
            ...
            If RadioButton1.Checked = True Then
                ...
                If obj2.Consumos_Historico("E", fechaBuscar, 0, "Domestico") Then
            ...
            ElseIf RadioButton2.Checked = True Then
                If obj2.Consumos_Historico("E", fechaBuscar, 0, "Industrial") Then
                    tablaServicio = obj2.tabla
                    DataGridView1.DataSource = tablaServicio
            ...
            ElseIf RadioButton3.Checked = True Then
                ...
                If obj2.Consumos_Historico("F", fechaBuscar, 0, "") Then
                    tablaServicio = obj2.tabla
                    DataGridView1.DataSource = tablaServicio
        ...
        ElseIf RadioButton6.Checked = True Then
            ...
            If obj2.Consumos_Historico("D", fechaBuscar, FK_NUM_MEDIDOR, "") Then
                tablaServicio = obj2.tabla
                DataGridView1.DataSource = tablaServicio
