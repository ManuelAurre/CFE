...
Public Class ConsultaDeReciboCliente
    Dim Cli As New UsuarioVS
    Dim fa As New EnlaceBD
    ...
    Private Sub ConsultarResibo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Cli._users = User
        dtt = fa.ClienteConectado(Cli)
        Dim CURP_Cliente As String
        CURP_Cliente = dtt.Rows(0)("CURP_Cliente")

        If obj.CONSULTAR_Servicio("A", CURP_Cliente) Then
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Dim tablaClientes3 As New DataTable
        ...
        If obj3.Recibo_Pagado(fechoso, 0, NumerodeMedidor) Then
            Me.Close()
        End If
