...
Public Class ReporteDeConsumos
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        Me.Close()
    End Sub

    Private Sub ReporteDeConsumos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim obj2 As New EnlaceBD
        Dim tablaServicio As New DataTable

        If obj2.REPORTE_Consumos("D", Today()) Then
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If obj2.REPORTE_Consumos("D", fechaBuscar) Then
            tablaServicio = obj2.tabla
            DataGridView1.DataSource = tablaServicio
    ...
    Private Sub ExportDataToPDFTable()
        ...
        Dim doc As New Document(New Rectangle(1300.0F, 720.0F), 100, 1, 1, 1)
        ...
        Dim widths As Single() = New Single() {2.0F, 2.0F, 2.0F, 1.0F, 1.0F}
        ...
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Consumo Basico", font12Bold)))
        'Alignment of phrase in the pdfcell
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        'Add pdfcell in pdftable
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Consumo Intermedio", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Consumo Excedente", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Año de Consumo", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
        PdfPCell = New PdfPCell(New Phrase(New Chunk("Mes de Consumo", font12Bold)))
        PdfPCell.HorizontalAlignment = PdfPCell.ALIGN_CENTER
        PdfTable.AddCell(PdfPCell)
